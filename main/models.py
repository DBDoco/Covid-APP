...
class Student (models.Model):
    ...
    student_fakultet=models.OneToOneField(Fakultet, on_delete=models.CASCADE, default='')
    student_cijepljen=models.BooleanField(default=True)
    student_cjepivo=models.OneToOneField(Cjepivo, on_delete=models.CASCADE, default='')
...
class Zaposlenik (models.Model):
    ...
    zaposlenik_cjepivo=models.OneToOneField(Cjepivo, on_delete=models.CASCADE, default='')
